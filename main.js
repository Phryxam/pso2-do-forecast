(function () {
    ...
    var ORDER_DATA = [
        ...
        ['龍祭壇探索(Recommended)', '2016-09-03', [16]],
        ['Coast Exploration(Recommended)', '2016-09-04', [16]],
        ['採掘場跡探索(Recommended)', '2016-09-05', [16]],
        ['海底探索(Recommended)', '2016-09-06', [16]],
        ['白ノ領域探索(Recommended)', '2016-09-07', [16]],
        ['浮上施設探索(Recommended)', '2016-09-08', [16]],
        ['黒ノ領域探索(Recommended)', '2016-09-09', [16]],
        ['東京探索(Recommended)', '2016-08-25', [16]],
        ['ラスベガス探索(Recommended)', '2016-08-26', [16]],
        ['ナヴ・ラッピー捕獲任務(Recommended)', '2016-04-21', [21]],
        ['ウォルガーダ殲滅(Recommended)', '2016-04-21', [21]],
        ['狂暴化龍族鎮圧:浮遊大陸(Recommended)', '2016-04-22', [21]],
        ['黒の民鎮圧任務:白ノ領域(Recommended)', '2016-04-22', [21]],
        ['キャタドランサ討伐(Recommended)', '2016-04-23', [21]],
        ['浮上施設地域生態調査(Recommended)', '2016-04-23', [21]],
        ['アークス捜索任務:凍土(Recommended)', '2016-04-24', [21]],
        ['ソル・ディランダール討伐(Recommended)', '2016-04-24', [21]],
        ['遺跡侵食度調査(Recommended)', '2016-04-25', [21]],
        ['ウォパル救助隊(Recommended)', '2016-04-25', [21]],,
        ['ゴロンゾラン鎮圧(Recommended)', '2016-04-26', [21]],
        ['幻創種撃退任務:東京(Recommended)', '2016-04-26', [21]],
        ['機甲種性能調査:地下坑道(Recommended)', '2016-04-27', [21]],
        ['アンジャドゥリリ討伐(Recommended)', '2016-04-27', [21]],
        ['救難信号調査(Recommended)', '2016-04-28', [21]],
        ['オルグブラン討伐(Recommended)', '2016-04-28', [21]],
        ['稀少鉱石発掘任務(Recommended)', '2016-04-29', [21]],
        ['移動要塞型機甲種撃破(Recommended)', '2016-04-29', [21]],
        ['デコル・マリューダ討伐(Recommended)', '2016-04-30', [21]],
        ['黒の民鎮圧任務:黒ノ領域(Recommended)', '2016-04-30', [21]],
        ['凍土地域状況調査(Recommended)', '2016-05-01', [21]],
        ['レオマドゥラード討伐(Recommended)', '2016-05-01', [21]],
        ['貴重物資運搬計画:砂漠(Recommended)', '2016-05-02', [21]],
        ['コドッタ・イーデッタ討伐(Recommended)', '2016-05-02', [21]],
        ['ダガン殲滅任務:森林(Recommended)', '2016-05-03', [21]],
        ['トレイン・ギドラン討伐(Recommended)', '2016-05-03', [21]],
        ['カルターゴ殲滅(Recommended)', '2016-05-04', [21]],
        ['機甲種性能調査:砂漠(Recommended)', '2016-05-04', [21]],
        ['ザウーダン討伐(Recommended)', '2016-05-05', [21]],
        ['龍祭壇平定任務(Recommended)', '2016-05-05', [21]],
        ['キャタドラン討伐(Recommended)', '2016-05-06', [21]],
        ['リリーパ族集落防衛(Recommended)', '2016-05-06', [21]],
        ['指定標本回収:浮遊大陸(Recommended)', '2016-05-07', [21]],
        ['環境保全任務:海岸(Recommended)', '2016-05-07', [21]],
        ['フォンガルフ討伐(Recommended)', '2016-05-08', [21]],
        ['デ・マルモス鎮圧(Recommended)', '2016-05-08', [21]],
        ['龍族生態調査(Recommended)', '2016-05-09', [21]],
        ['機甲種性能調査:採掘場跡(Recommended)', '2016-05-09', [21]],
        ['環境汚染装置破壊(Recommended)', '2016-05-10', [21]],
        ['海岸地域生態調査(Recommended)', '2016-05-10', [21]],
        ['巨大変形機甲種撃破(Recommended)', '2016-05-11', [21]],
        ['海底地域生態調査(Recommended)', '2016-05-11', [21]],
        ...
        ['Runs Exploration(SH)', '2016-01-31', [15, 15, 24, 18, 21]],
